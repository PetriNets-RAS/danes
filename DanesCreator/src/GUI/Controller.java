    ...
    public void addResource(String name, int x, int y) {
        ...
        if (graph instanceof PetriNet) {
            ...
            if (name.equals("R")) {
                ...
                } while (!((PetriNet) graph).addResource(resource));
            } else // Normal add
            {
    ...
    public void addTransition(String name, int x, int y) {
        ...
        if (graph instanceof PetriNet) {
            ...
            if (name.equals("T")) {
                ...
                } while (!((PetriNet) graph).addTransition(transition));
            } else // Normal add
            {
        ...
        if (graph instanceof PetriNet) {
            ...
            if (name.equals("Arc")) {
                ...
                do {
                    ...
                    _offset++;
                } while (!((PetriNet) graph).addArc(arc));
            } else // Normal add
            {
        ...
        if (graph instanceof PrecedenceGraph) {
            ...
            if (name.equals("Arc")) {
                ...
                do {
                    ...
                    _offset++;
                } while (!((PrecedenceGraph) graph).addArc(arc));
            } else // Normal add
            {
                arc = new Arc(name, out, in);
    ...
    public void addNode(String name, int x, int y) {
        ...
        if (graph instanceof PrecedenceGraph) {
            ...
            if (name.equals("Node")) {
                ...
                } while (!((PrecedenceGraph) graph).addNode(node));
            } else // Normal add
            {
                node = new Node(name);
                node.setX(x);
...
//        }
        ...
        if (graph instanceof PrecedenceGraph) {
            ...
            // Arc
            for (Arc a : ((PrecedenceGraph) graph).getListOfArcs()) {
                //x1= ((Node) a.getOutElement()).getWidth() / 2 + a.getOutElement().getX();
                //y1= ((Node) a.getOutElement()).getHeight() / 2 + a.getOutElement().getY();
                x1 = a.getInElement().getX();
                y1 = a.getInElement().getY();
                x2 = a.getOutElement().getX();
                y2 = a.getOutElement().getY();
//                System.out.println("Element x: " + a.getInElement().getX());
//                System.out.println("Element y: " + a.getInElement().getY());
//                System.out.println("Arc x: " + a.getX());
//                System.out.println("Arc y: " + a.getY());
//                System.out.println("Arc x: " + a.getIntercectionX());
//                System.out.println("Arc y: " + a.getIntercectionY());
                // Width and Height depends on element
                x1 += 25;
                y1 += 25;
                x2 += 25;
